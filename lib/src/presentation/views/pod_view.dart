...
import 'package:account_data_portal/src/data/models/api_data/pod.dart';
...
class PodView extends StatelessWidget {
  const PodView({Key? key, this.data}) : super(key: key);
  final List<Pod>? data;
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      body: Column(
        children: [
          const Text(
            'POD Transaction Proportion Chart (Top 5)',
            style: titleStyle,
          ),
          const Text(
            '2021-05-31 to 2022-05-31 Top 5 POD trading volume as a 100.00 of total trading volume',
